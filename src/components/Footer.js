    ...
    <div className="px-6 py-14 md:px-10 md:pt-20 md:pb-16 pt-20 pb-16 bg-darkGrey xl:w-full xl:px-0">
      <div className="grid gap-x-5 grid-cols-4 md:grid-cols-8 lg:grid-cols-12 xl:max-w-6xl xl:mx-auto">
        ...
        <div className="mb-10 pt-2">
          ...
          <a href="/nitro" className="block text-white mt-2">
            Nitro
          </a>
        ...
        <div className="mb-10 pt-2 row-start-3 md:row-start-2 md:col-start-5 lg:col-start-9 lg:row-start-1">
          ...
          <a href="/support" className="block text-white mt-2">
            Support
          </a>
          <a href="/safety" className="block text-white mt-2">
            Safety
          </a>
          <a href="/safety" className="block text-white mt-2">
            Blog
      ...
      <div className="flex justify-between pt-8 border-t-[1.5px] border-heroBlue xl:max-w-6xl xl:mx-auto">
        ...
        <button className="bg-mainBlue text-white px-4 py-2 rounded-3xl text-sm">
          Download
        </button>
      </div>
    </div>
